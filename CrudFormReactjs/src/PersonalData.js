    ...
    <tbody>
        ...
        {personaldata.map(pd=>
            <tr key={pd.ROW_ID}>
                ...
                <td>{pd.PASSPORT_NUMBER}</td>
                <td>{pd.FIRST_NAME}</td>
                <td>{pd.LAST_NAME}</td>
                <td>{pd.WORK_EMAIL}</td>
                <td>{pd.PERSONAL_EMAIL}</td>
                <td>{pd.DATE_OF_BIRTH}</td>
                <td>{pd.STATE_OF_BIRTH}</td>
                <td>{pd.BIRTH_PLACE}</td>
                <td>{pd.GENDER}</td>
                <td>{pd.NATIONALITY}</td>
                <td>{pd.MARTIAL_STATUS}</td>
...
<div className="modal-content">
   ...
   <div className="modal-body">
       ...
       <div className="input-group mb-3">
        <span className="input-group-text">Passport Number</span>
        <input type="text" className="form-control"
        value={PassportNumber}
        onChange={this.changePassportNumber}/>
       </div>
       ...
       <div className="input-group mb-3">
        <span className="input-group-text">StateOfBirth</span>
        <input type="text" className="form-control"
        value={StateOfBirth}
        onChange={this.changeStateOfBirth}/>
       </div>

       <div className="input-group mb-3">
        <span className="input-group-text">BirthPlace</span>
        <input type="text" className="form-control"
        value={BirthPlace}
       ...
       <div className="input-group mb-3">
        <span className="input-group-text">MartialStatus</span>
        <input type="text" className="form-control"
        value={MartialStatus}
        onChange={this.changeMartialStatus}/>
       </div>
